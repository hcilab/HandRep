...
public class EnchanterLogger : BaseLogger
{    //PATTERN
    ...
    public void LogEnchantEvent(XRBaseInteractable interactable, string mod = "")
    {
        string type = "D_enchant";
        string eventType = "Enchant";
        if (!mod.Equals(""))
        {
            eventType += ":" + mod;
        }
