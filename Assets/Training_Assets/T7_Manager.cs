...
public class T7_Manager : MonoBehaviour
{
    ...
    [SerializeField] XRSocketInteractor bowlSocket;
    ...
    public UnityEvent ResetDone = null;
    ...
    public void GrindItem(GameObject newItem)
    {
