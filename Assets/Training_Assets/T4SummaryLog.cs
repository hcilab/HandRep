...
public class T4SummaryLog : BaseDataLog
{
    ...
    public void Start()
    {
        ...
        headers += ",Start Time,End Time,Task,Closed With Hand"; 
    ...
    public void EndTrial(int trial, bool closedWitHand)
    {
        float timeMillis = Time.time * 1000;
